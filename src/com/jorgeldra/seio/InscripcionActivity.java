...
public class InscripcionActivity extends Activity implements AdapterView.OnItemClickListener ,SearchView.OnQueryTextListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String contenido =MainActivity.almacenCustomSection.buscarPorTitulo("Inscripción").getContent();
		//contenido = contenido.replace("<a href=\"../../es/c/secretaria-tecnica\">","<a href=\"http://www.seio2012.com/es/c/secretaria-tecnica\">"); //eliminamos del contenido - Ver Más
		contenido = contenido.replace("<a href=\"../../es/c/secretaria-tecnica\">","<a href=\"http://89.129.192.78/seio2012/es/c/secretaria-tecnica\">"); //eliminamos del contenido - Ver Más
		
		titulo = (TextView)findViewById(R.id.titleInscripcion);
		titulo.setText(MainActivity.almacenCustomSection.buscarPorTitulo("Inscripción").getTitle());
