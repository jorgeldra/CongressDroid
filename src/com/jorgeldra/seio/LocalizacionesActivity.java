...
import com.jorgeldra.seio.adaptador.ListLocalizacionesAdapter;
...
public class LocalizacionesActivity extends Activity implements AdapterView.OnItemClickListener, SearchView.OnQueryTextListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// menu lateral google
		mSeioTitles = getResources().getStringArray(
				R.array.seio_navigation_array);
		...
		if (!dataManager.obtenerSedes().isEmpty()) { //si la lista de localizaciones no es vacia mostramos el listview
			
			TextView txtVacio = (TextView) findViewById(com.jorgeldra.seio.R.id.emptyListaLocalizaciones);
			txtVacio.setVisibility(View.GONE);
			ListView list = (ListView) findViewById(com.jorgeldra.seio.R.id.listaLocalizaciones);
		
			ListLocalizacionesAdapter adaptador = new ListLocalizacionesAdapter(this,dataManager.obtenerSedes());
