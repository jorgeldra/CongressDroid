...
public class FechasActivity extends Activity implements AdapterView.OnItemClickListener,SearchView.OnQueryTextListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String contenido = MainActivity.almacenCustomSection.buscarPorTitulo("Fechas").getContent();
		
		titulo = (TextView)findViewById(R.id.titleFechas);
		titulo.setText(MainActivity.almacenCustomSection.buscarPorTitulo("Fechas").getTitle());
		
		webView = (WebView) findViewById(R.id.webViewFechas);
