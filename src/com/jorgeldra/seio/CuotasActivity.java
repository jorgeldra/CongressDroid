...
public class CuotasActivity extends Activity implements AdapterView.OnItemClickListener,SearchView.OnQueryTextListener {
private WebView webView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String contenido =MainActivity.almacenCustomSection.buscarPorTitulo("Cuotas").getContent();
	
		titulo = (TextView)findViewById(R.id.titleCuotas);
		titulo.setText(MainActivity.almacenCustomSection.buscarPorTitulo("Cuotas").getTitle());
		
		webView = (WebView) findViewById(R.id.webViewCuotas);
